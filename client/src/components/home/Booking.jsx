...
function Booking() {
  return (
    <section className="px-5 md:px-40 text-center mt-20 w-full">
      <SectionHeader
      ...
      <div className="flex gap-5 items-end flex-col md:flex-row w-full">
        <div className="bg-[#F9F9FB] w-full md:w-1/3 h-54 flex flex-col items-start justify-between rounded-t-3xl py-10 px-8 md:px-12">
        ...
        <div className="relative w-full md:w-1/3">
          ...
          <div className="inverted-radius relative w-full h-76 flex flex-col items-start gap-2 text-white bg-[#2986FE]/99 px-8 md:px-12 py-8 shadow-lg">
